 ...
 * @author user
 */
public class menuPesquisas extends javax.swing.JFrame {

    /**
     * Creates new form menuPesquisas
     */
    public menuPesquisas() {
        initComponents();
        processar();
    }
    
     userControl uc = new userControl();
    String [] CUsers = {"ID", "Estado"};
    public void processar(){
        uc.preenchelistaBloqueio();
        tabela1.setModel(new DefaultTableModel(uc.transformaListaEmTentativas(), CUsers));
    ...
    private void initComponents() {
        ...
        tabela1.setBackground(new java.awt.Color(0, 102, 153));
        ...
        jLabel1.setText("Pesquisar DATAS");
